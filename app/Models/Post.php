...
class Post extends Model
{
    ...
    protected $fillable = ['title', 'content', 'post_series_id', 'author_id', 'blog_id', 'is_draft', 'starttime', 'promo_image', 'publish_date', 'slug'];
    ...
    {
        return $this->belongsToMany(Tag::class, 'tagged_posts')->orderBy('slug');
    }
